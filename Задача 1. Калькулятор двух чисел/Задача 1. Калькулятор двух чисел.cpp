...
public:
    ...
    bool set_num1(double num)// - метод должен установить значение поля num1 равное значению аргумента num1 в случае, если значение аргумента не равно 0. Возвращает true, если установка произошла успешно, в обратном случае false
    {
		if (!num)
		{
	...
	bool set_num2(double num)// - метод должен установить значение поля num2 равное значению аргумента num2 в случае, если значение аргумента не равно 0. Возвращает true, если установка произошла успешно, в обратном случае false
	{
		if (!num)
		{
			std::cout << "You can't divide by zero." << std::endl;
...
int main(int argc, char** argv)
{
	...
	std::cin >> In_num1;
	test.set_num1(In_num1);
	test.set_num1(In_num1);
	
	std::cout << "Enter num2 :" << std::endl;
	std::cin >> In_num2;
	test.set_num2(In_num2);
